...
func TestUpdateProducts(t *testing.T) {
	testCases := []struct {
		...
		mSellerProductIDs_Behavior   func(rMock *RepoMock, expectedInput uint64, returns []uint64, returnsErr error)
		...
		mManageProducts_Behavior      func(rMock *RepoMock, expSellerId uint64, expToAdd []models.Product, expToUpd []models.Product, expToDel []models.Product, returns UpdateResults, returnsErr error)
	...
	}{
		{
			...
			mSellerProductIDs_Behavior: func(rMock *RepoMock, expectedInput uint64, returns []uint64, returnsErr error) {},
			mManageProducts_Behavior: func(rMock *RepoMock, expSellerId uint64, expToAdd, expToUpd, expToDel []models.Product, returns UpdateResults, returnsErr error) {
			},
		...
		},
		{
			...
			mManageProducts_Behavior: func(rMock *RepoMock, expSellerId uint64, expectedToAdd, expectedToUpd, expectedToDel []models.Product, returns UpdateResults, returnsErr error) {
