...
//go:generate minimock -i github.com/hablof/merchant-experience/internal/router.TableDownloader -o ./internal\router\table_downloader_mock_test.go -n TableDownloaderMock
